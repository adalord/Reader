...
namespace Tools
{
    public class MyRichTextBox:System.Windows.Forms.RichTextBox
    {
        ...
        {
            if (m.Msg == 0x7 || m.Msg == 0x201 || m.Msg == 0x202 || m.Msg == 0x203 || m.Msg == 0x204 || m.Msg == 0x205 || m.Msg == 0x206 || m.Msg == 0x0101)
            {
                //m.Msg == 0x7|| m.Msg == 0x201 || m.Msg == 0x202|| m.Msg == 0x203 || m.Msg == 0x204 || m.Msg == 0x205 || m.Msg == 0x206 || m.Msg == 0x0100 || m.Msg == 0x0101
